...
public class PingClient {
    ...
    {
        if (args.length != 2) {
            System.out.println("Requiridos argumentos: servidor porta");
            return;
        }
        ...
        while (sequence_number < 10) {
            ...
            try {
                ...
                System.out.println("Timeout do pacote " + sequence_number);
            }
    ...
    private static void printData(DatagramPacket request, long delayTime) throws Exception {
        ...
        System.out.println("Recebido de " + request.getAddress().getHostAddress() + " : " + new String(line) + " Delay: " + delayTime );
    }
}